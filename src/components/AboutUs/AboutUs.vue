      ...
      <div class="container">
        <div class="know_us_container">
          ...
          <div class="description">
            ...
            <div class="des">
              <h4>رؤيتنا</h4>
              <p>الريادة في خدمة المجتمع من أجل مجتمع صحي واع.</p>
            </div>
          </div>
          <div class="description">
            <div class="img_container">
            ...
            <div class="des">
              ...
              <ul>
                <li><p>
                تقديم الخدمات الصيدلانية المتكاملة إلى كافة شرائح المجتمع، وحماية المجتمع من المنتج المقلد والسعر المبالغ فيه بحسب شعار الشركة: (المنتج الأصل بالسعر الأقل)
              </p></li>
              </ul>
      ...
      <div class="container">
        ...
        <div class="services">
          <div class="service">
            ...
            <p>
              هي خدمة رائدة تقدمها صيدليات المجتمع تهدف إلى تقديم الخدمة الصيدلانية تحقيقاً لمعنى طب
            </p>
          </div>
          <div class="service">
            <div class="icon_container">
            ...
            <p>
              هي مجلة تعنى بالمجال الصحي الطبي والصيدلاني وتقوم بطرح آخر
          ...
          <div class="service">
            ...
            <p>
              يتيح لعملائه الكرام التسوق والشراء من خلال الصيدلية الإلكترونية على الموقع الرسمي لصيدليات المجتمع كما يقدم المتجر خدمة التوصيل المجاني
            </p>
          </div>
          <div class="service">
            <div class="icon_container">
            ...
            <h3>خدمة العملاء</h3>
            <p>
              اقتراحاتكم ونصائحكم وحتى شكاواكم هي محل اهتمامنا و يمكننا تقديمها من خلال تذاكر الدعم الفني ووسائل التواصل الاجتماعي
            </p>
          </div>
        </div>
      </div>
