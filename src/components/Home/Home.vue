  ...
  <div>
    ...
    <section class="distinguished_clients">
      <div class="description">
        ...
        <h4>
هو برنامج يتيح لعملاء صيدليات المجتمع الحصول على بضاعة مجانية تعادل 3 % من مشترياتهم عند الوصول إلى مبلغ 300 ريال (غير شامل ضريبة القيمة المضافة) من أي من فروعها أو الموقع الإلكتروني والتطبيق.
        </h4>
        <p>
          يعد برنامج عميل التميز من أفضل برامج جمع النقاط في المملكة. 
        </p>
        <p>* عد الوريقات والحفائظ وبعض الأدوية حيث تحسب البضاعة المجانية بما يعادل 1 % من قيمة المشتريات ولا يتم احتساب أي نقاط لمشتريات الحبيبات ومنتجات الرضاعة الصناعية حسب تعميم وزارة الصحة بمنع الترويج للمنتجات المساعدة على الرضاعة الصناعية تشجيعا للرضاعة الطبيعية</p>
      </div>
      <div class="imgs">
        <div class="img_container">
