...
export default {
    ...
    addCategory(){
            ...
            if(this.$route.params.id !== undefined){
                axios.post(`https://app.almujtama.com.sa/admin/headCategory/${this.$route.params.id}`, this.category, {
                ...
                axios.post('https://app.almujtama.com.sa/admin/headCategory', this.category, {
                    headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
                })
                .then( res => {
        ...
        getCategory(){
            if(this.$route.params.id !== undefined){
                axios.get(`https://app.almujtama.com.sa/admin/headCategory/${this.$route.params.id}`, {
                    headers: {
